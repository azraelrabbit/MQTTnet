            ...
            try
            {
                ...
                if (_tcpOptions.TlsOptions?.UseTls == true)
                {
                    ...
                    try
                    {
                        ...
                        await TaskEx.Run(() => sslStream.AuthenticateAsClient(_tcpOptions.Server, LoadCertificates(), _tcpOptions.TlsOptions.SslProtocol, !_tcpOptions.TlsOptions.IgnoreCertificateRevocationErrors));//.ConfigureAwait(false);
