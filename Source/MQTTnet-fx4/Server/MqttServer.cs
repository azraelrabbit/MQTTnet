...
namespace MQTTnet.Server
{
    public class MqttServer : Disposable, IMqttServer
    {
        ...
        public Task<MqttClientPublishResult> PublishAsync(MqttApplicationMessage applicationMessage, CancellationToken cancellationToken)
        {
            ...
            Func<MqttClientPublishResult> p = () => { return new MqttClientPublishResult(); };
            return Task<MqttClientPublishResult>.Factory.StartNew(p);//FromResult(new MqttClientPublishResult());
        }
