...
namespace MQTTnet.Server.Internal
{
    public sealed class MqttClientSessionsManager : IDisposable
    {
        ...
        private Func<List<IMqttClientStatus>> func;
        ...
        {
            Task.Factory.StartNew(() => TryProcessQueuedApplicationMessagesAsync(cancellationToken), cancellationToken)
            ...
            CancellationToken cancellationToken)
        {
            try
            {
                ...
                ct.CancelAfter(_options.DefaultCommunicationTimeout);
                using(var timeoutToken = ct)
                {
        ...
        public Task<IList<IMqttClientStatus>> GetClientStatusAsync()
        {
            ...
            Func<IList<IMqttClientStatus>> function = () => { return result; };
            return Task<IList<IMqttClientStatus>>.Factory.StartNew(function);
                
                
                // FromResult((IList<IMqttClientStatus>) result);
        }
        ...
        public Task<IList<IMqttSessionStatus>> GetSessionStatusAsync()
        {
            ...
            Func<IList<IMqttSessionStatus>> function = () => { return result; };
            return Task<IList<IMqttSessionStatus>>.Factory.StartNew(function);
        }
