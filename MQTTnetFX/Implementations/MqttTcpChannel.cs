            ...
            try
            {
                ...
                if (_tcpOptions.TlsOptions?.UseTls == true)
                {
                    ...
                    try
                    {
                        ...
                        // sslStream.AuthenticateAsClient(_tcpOptions.Server, LoadCertificates(), _tcpOptions.TlsOptions.SslProtocol, !_tcpOptions.TlsOptions.IgnoreCertificateRevocationErrors);                 
